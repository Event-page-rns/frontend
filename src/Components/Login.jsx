...
const Login = () => {
  return (
    ...
    <div className='felx justify-center items-center border-2 border-black rounded-md p-4'>
        <div class="max-w-md relative flex flex-col p-4 rounded-md text-black bg-white">
    <div class="text-2xl font-bold mb-2 text-black text-center">Welcome back to <span class="= text-red-500">App</span></div>
...
<form class="flex flex-col gap-3">
    ...
    <div>
    <a class="text-sm text-red-500" href="#">Forgot your password?
    </a></div>
    <button type="submit" class="bg-red-500 w-max m-auto px-6 py-2 rounded text-white text-sm font-normal">Submit</button>

</form>
<div class="text-sm text-center mt-[1.6rem]">Don’t have an account yet? <a class="text-sm text-red-500" href="#">Sign up for free!</a></div>
</div>
    </div>
    </div>
  )
